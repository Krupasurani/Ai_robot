...
export const paths = {
  ...
  dashboard: {
    ...
    knowledgebase: {
      root: `${ROOTS.DASHBOARD}knowledge-bases`,
      records: `${ROOTS.DASHBOARD}knowledge-records`,
    ...
    agent: {
      ...
      conversation: (agentKey: string, conversationId: string) => `${ROOTS.DASHBOARD}agents/${agentKey}/conversations/${conversationId}`,
    },
    promptLibrary: {
      root: `${ROOTS.DASHBOARD}prompt-library`,
    },
  },
};
