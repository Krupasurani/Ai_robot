...
interface JiraSetupViewProps {
    showStats?: boolean;
}

export const JiraSetupView: React.FC<JiraSetupViewProps> = () => {
    ...
    const features = [
        { text: 'Index user permissions associated with documents' },
        { text: 'Content and permissions updates sync multiple times every hour' },
        { text: 'Search for issues, stories, tasks, epics, dashboards, and filters' },
    ];
    ...
    const guideContent = (
        <>
            ...
            <div>
                ...
                <div className="space-y-2 ml-7">
                    ...
                    <ol className="list-decimal list-inside text-sm text-muted-foreground space-y-1 mt-2">
                        ...
                        <li>Enter a name (e.g., &quot;Thero Jira Integration&quot;)</li>
                ...
                <div className="space-y-2 ml-7">
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                        <li className="flex items-start gap-2">
                            ...
                            <span><strong>Jira API</strong> → Configure → Add all &quot;read&quot; scopes</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            <div>
                ...
                <div className="space-y-2 ml-7">
                    <p className="text-sm text-muted-foreground">
                        Your Atlassian domain is the URL you use to access Jira:
                    </p>
                    <div className="rounded-md bg-muted p-2 text-xs font-mono text-foreground">
                        https://your-company.atlassian.net
                    </div>
                    <p className="text-xs text-muted-foreground">
                        You can find this in your browser&apos;s address bar when logged into Jira.
                    </p>
                </div>
            </div>
            ...
            <div className="rounded-lg bg-primary/5 border border-primary/20 p-3">
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        >
                            View Jira Cloud API Documentation →
                        </a>
                    </div>
                </div>
            </div>
    ...
    return (
        <>
            <ConnectorSetupLayout
                connectorName="Jira"
                connectorDisplayName="Jira (Cloud)"
                connectorSubtitle="Atlassian"
                iconPath={connector?.iconPath || '/assets/icons/connectors/jira.svg'}
                features={features}
            ...
            >
                ...
                <SetupStepSection
                    number={1}
                    description="Grant access in Jira by installing the Thero app. Follow the instructions in the document provided below."
                >
                    <a
                        href="https://developer.atlassian.com/console/myapps/"
                        target="_blank"
                ...
                <SetupStepSection
                    number={2}
                    description="Provide the following information about your Jira instance:"
                >
                    {authFields.length > 0 ? (
                        ...
                        // Fallback if no fields from backend yet
                ...
                {connector?.isConfigured && (
                    <div className="pt-6">
                        <ConnectorDetailStats connectorName="Jira" />
                    </div>
                )}
            </ConnectorSetupLayout>
