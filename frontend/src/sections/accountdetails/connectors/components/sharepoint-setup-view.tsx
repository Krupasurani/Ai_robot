...
interface SharePointSetupViewProps {
    showStats?: boolean;
}

export const SharePointSetupView: React.FC<SharePointSetupViewProps> = () => {
    ...
    const features = [
        { text: 'Sync documents from SharePoint sites' },
        { text: 'Index lists, libraries, and pages' },
        { text: 'Respect site and document permissions' },
    ];
    ...
    const guideContent = (
        <>
            ...
            <div>
                ...
                <div className="space-y-2 ml-7">
                    <p className="text-sm text-muted-foreground">
                        Add required SharePoint permissions:
                    </p>
                    <ul className="text-sm text-muted-foreground space-y-1">
                        <li className="flex items-start gap-2">
                            <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                            <span><code className="text-xs bg-muted px-1 rounded">Sites.Read.All</code></span>
                        </li>
                        <li className="flex items-start gap-2">
                            <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            <div className="rounded-lg bg-primary/5 border border-primary/20 p-3">
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <a
                            href="https://docs.microsoft.com/en-us/graph/api/resources/sharepoint"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs text-primary hover:underline"
                        >
                            View SharePoint Graph API Documentation →
                        </a>
                    </div>
                </div>
            </div>
    ...
    return (
        <>
            <ConnectorSetupLayout
                ...
                connectorDisplayName="Microsoft SharePoint"
                connectorSubtitle="Microsoft 365"
                iconPath={connector?.iconPath || '/assets/icons/platforms/ic-sharepoint.svg'}
                features={features}
            ...
            >
                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            id="connector-name"
                            defaultValue="Microsoft SharePoint"
...
export default SharePointSetupView;
