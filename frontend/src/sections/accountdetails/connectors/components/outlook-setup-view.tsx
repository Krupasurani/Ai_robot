...
export const OutlookSetupView: React.FC<OutlookSetupViewProps> = () => {
    ...
    const features = [
        ...
        { text: 'Search through email threads' },
        { text: 'Respect mailbox permissions' },
    ];
                ...
                <div className="space-y-2 ml-7">
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                        <li className="flex items-start gap-2">
                            ...
                            <span><code className="text-xs bg-muted px-1 rounded">Mail.Read</code></span>
                        </li>
                        <li className="flex items-start gap-2">
                            <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            <div className="rounded-lg bg-primary/5 border border-primary/20 p-3">
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <a
                            href="https://docs.microsoft.com/en-us/graph/api/resources/mail-api-overview"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs text-primary hover:underline"
                        >
                            View Outlook Graph API Documentation →
                        </a>
                    </div>
                </div>
            </div>
    ...
    return (
        <>
            <ConnectorSetupLayout
                ...
                connectorDisplayName="Microsoft Outlook"
                connectorSubtitle="Microsoft 365"
                iconPath={connector?.iconPath || '/assets/icons/platforms/ic-outlook.svg'}
                features={features}
            ...
            >
                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            id="connector-name"
                            defaultValue="Microsoft Outlook"
                ...
                <SetupStepSection
                    number={1}
                    description="Register an application in Azure Active Directory."
                >
                    <a
                        href="https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationsListBlade"
                        target="_blank"
                ...
                {connector?.isConfigured && (
                    <div className="pt-6">
                        <ConnectorDetailStats connectorName="Outlook" />
                    </div>
                )}
            </ConnectorSetupLayout>
...
export default OutlookSetupView;
