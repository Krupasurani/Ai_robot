...
export const TeamsSetupView: React.FC<TeamsSetupViewProps> = () => {
    ...
    const features = [
        { text: 'Index messages from Teams channels' },
        { text: 'Search through shared files' },
        { text: 'Respect team and channel permissions' },
    ];
            ...
            <div>
                ...
                <div className="space-y-2 ml-7">
                    ...
                    <ol className="list-decimal list-inside text-sm text-muted-foreground space-y-1 mt-2">
                        ...
                        <li>Enter app name (e.g., &quot;Thero Teams&quot;)</li>
                ...
                <div className="space-y-2 ml-7">
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                        <li className="flex items-start gap-2">
                            ...
                            <span><code className="text-xs bg-muted px-1 rounded">Team.ReadBasic.All</code></span>
                        </li>
                        <li className="flex items-start gap-2">
                            <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                            <span><code className="text-xs bg-muted px-1 rounded">Channel.ReadBasic.All</code></span>
                        </li>
                        <li className="flex items-start gap-2">
                            <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                            <span><code className="text-xs bg-muted px-1 rounded">ChannelMessage.Read.All</code></span>
                        </li>
                        <li className="flex items-start gap-2">
                            <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            <div className="rounded-lg bg-primary/5 border border-primary/20 p-3">
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        >
                            View Microsoft Teams API Documentation →
                        </a>
                    </div>
                </div>
            </div>
    ...
    return (
        <>
            <ConnectorSetupLayout
                ...
                iconPath={connector?.iconPath || '/assets/icons/platforms/ic-teams.svg'}
                features={features}
