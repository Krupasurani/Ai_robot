...
interface OneDriveSetupViewProps {
    showStats?: boolean;
}

export const OneDriveSetupView: React.FC<OneDriveSetupViewProps> = () => {
    ...
    const features = [
        { text: 'Sync files and folders from OneDrive' },
        { text: 'Index user permissions for secure access' },
        { text: 'Support for personal and shared drives' },
    ];
            ...
            <div>
                ...
                <div className="space-y-2 ml-7">
                    ...
                    <ol className="list-decimal list-inside text-sm text-muted-foreground space-y-1 mt-2">
                        ...
                        <li>Enter app name (e.g., &quot;Thero OneDrive&quot;)</li>
                ...
                <div className="space-y-2 ml-7">
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                        <li className="flex items-start gap-2">
                            ...
                            <span><code className="text-xs bg-muted px-1 rounded">Files.Read.All</code></span>
                        </li>
                        <li className="flex items-start gap-2">
                            <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            <div className="rounded-lg bg-primary/5 border border-primary/20 p-3">
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <a
                            href="https://docs.microsoft.com/en-us/graph/api/resources/onedrive"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs text-primary hover:underline"
                        >
                            View OneDrive Graph API Documentation →
                        </a>
                    </div>
                </div>
            </div>
    ...
    return (
        <>
            <ConnectorSetupLayout
                ...
                connectorDisplayName="Microsoft OneDrive"
                connectorSubtitle="Microsoft 365"
                iconPath={connector?.iconPath || '/assets/icons/platforms/ic-onedrive.svg'}
                features={features}
            ...
            >
                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            id="connector-name"
                            defaultValue="Microsoft OneDrive"
                ...
                <SetupStepSection
                    number={1}
                    description="Register an application in Azure Active Directory. Follow the instructions in the setup guide."
                >
                    <a
                        href="https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationsListBlade"
                        target="_blank"
                ...
                <SetupStepSection
                    number={2}
                    description="Provide your Azure AD application credentials:"
                >
                    {authFields.length > 0 ? (
...
export default OneDriveSetupView;
