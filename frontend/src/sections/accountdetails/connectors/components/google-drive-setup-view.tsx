...
interface GoogleDriveSetupViewProps {
    showStats?: boolean;
}

export const GoogleDriveSetupView: React.FC<GoogleDriveSetupViewProps> = () => {
    ...
    const features = [
        { text: 'Sync files, folders, and shared drives' },
        { text: 'Index Google Docs, Sheets, Slides, and other file types' },
        { text: 'Real-time updates when files change' },
    ];
    ...
    const guideContent = (
        <>
            ...
            <div>
                ...
                <div className="space-y-2 ml-7">
                    <p className="text-sm text-muted-foreground">
                        In your project, enable the required APIs:
                    </p>
                    <ul className="text-sm text-muted-foreground space-y-1">
                        ...
                        <li className="flex items-start gap-2">
                            <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                            <span>Search for <strong>&quot;Google Drive API&quot;</strong> and enable it</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
                            <span>Also enable <strong>&quot;Google Docs API&quot;</strong> and <strong>&quot;Google Sheets API&quot;</strong></span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="rounded-lg bg-primary/5 border border-primary/20 p-3">
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        >
                            View Google Drive API Documentation →
                        </a>
                    </div>
                </div>
            </div>
    ...
    return (
        <>
            <ConnectorSetupLayout
                connectorName="Drive"
                connectorDisplayName="Google Drive"
                connectorSubtitle="Google Workspace"
                iconPath={connector?.iconPath || '/assets/icons/connectors/drive.svg'}
                features={features}
            ...
            >
                ...
                <SetupStepSection
                    number={2}
                    description="Provide the following information about your Google Drive configuration:"
                >
                    {authFields.length > 0 ? (
                ...
                {connector?.isConfigured && (
                    <div className="pt-6">
                        <ConnectorDetailStats connectorName="Drive" />
                    </div>
                )}
            </ConnectorSetupLayout>
...
export default GoogleDriveSetupView;
