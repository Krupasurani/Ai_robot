  ...
  return (
    ...
    >
      ...
      <div className={cn('flex h-full w-full', loading || error ? 'invisible' : 'visible')}>
        ...
        <div
          className={cn(
            'h-full flex-grow relative overflow-hidden transition-all duration-300',
            !loading && !error && processedCitations.length > 0
              ? 'w-[calc(100%-280px)] border-r border-border'
              : 'w-full'
          )}
        >
          <div
            ref={containerRef}
            className={cn(
              'w-full h-full overflow-auto min-h-[100px] p-4',
              '[&_.html-rendered-content]:font-sans [&_.html-rendered-content]:leading-relaxed',
              '[&_.html-rendered-content]:max-w-full [&_.html-rendered-content]:break-words',
              '[&_.html-rendered-content_img]:max-w-full [&_.html-rendered-content_img]:h-auto',
              '[&_.html-rendered-content_pre]:bg-muted [&_.html-rendered-content_pre]:p-4',
              '[&_.html-rendered-content_pre]:rounded [&_.html-rendered-content_pre]:overflow-x-auto',
              '[&_.html-rendered-content_pre]:font-mono',
              '[&_.html-rendered-content_code]:font-mono [&_.html-rendered-content_code]:bg-muted',
              '[&_.html-rendered-content_code]:px-1 [&_.html-rendered-content_code]:py-0.5',
              '[&_.html-rendered-content_code]:rounded',
              '[&_.html-rendered-content_table]:border-collapse [&_.html-rendered-content_table]:mb-4',
              '[&_.html-rendered-content_table]:w-auto',
              '[&_.html-rendered-content_th]:border [&_.html-rendered-content_th]:border-border',
              '[&_.html-rendered-content_th]:p-2 [&_.html-rendered-content_th]:text-left',
              '[&_.html-rendered-content_th]:bg-muted',
              '[&_.html-rendered-content_td]:border [&_.html-rendered-content_td]:border-border',
              '[&_.html-rendered-content_td]:p-2 [&_.html-rendered-content_td]:text-left',
              '[&_.html-rendered-content_a]:text-primary [&_.html-rendered-content_a]:underline',
              '[&_.html-rendered-content_blockquote]:border-l-4 [&_.html-rendered-content_blockquote]:border-border',
              '[&_.html-rendered-content_blockquote]:pl-4 [&_.html-rendered-content_blockquote]:ml-0',
              '[&_.html-rendered-content_blockquote]:text-muted-foreground',
              '[&_.html-rendered-content_h1]:mt-6 [&_.html-rendered-content_h1]:mb-3',
              '[&_.html-rendered-content_h2]:mt-6 [&_.html-rendered-content_h2]:mb-3',
              '[&_.html-rendered-content_h3]:mt-6 [&_.html-rendered-content_h3]:mb-3',
              '[&_.html-rendered-content_h4]:mt-6 [&_.html-rendered-content_h4]:mb-3',
              '[&_.html-rendered-content_h5]:mt-6 [&_.html-rendered-content_h5]:mb-3',
              '[&_.html-rendered-content_h6]:mt-6 [&_.html-rendered-content_h6]:mb-3'
            )}
          >
