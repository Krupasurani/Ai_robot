...
const components: Options['components'] = {
  ...
  pre: ({ node, className, children }) => {
    ...
    const codeChild = !Array.isArray(children) && isValidElement(children) ? children : null;
    if (!codeChild || (codeChild as any).type !== 'code') {
    ...
    const data: CodeBlockProps['data'] = [
      {
        language,
        filename: 'index.js',
        code: ((codeChild as any).props as { children: string }).children ?? '',
      },
    ];
    return (
      <CodeBlock
