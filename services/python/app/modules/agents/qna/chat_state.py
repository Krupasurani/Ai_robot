...
def build_initial_state(chat_query: Dict[str, Any], user_info: Dict[str, Any], llm: BaseChatModel,
    ...
    return {
        ...
        "reasoning_enabled": chat_query.get("reasoningEnabled", False),
        # Language preference is no longer passed through from the client; language handling
        # is determined inside the agent graph / prompts as needed.
