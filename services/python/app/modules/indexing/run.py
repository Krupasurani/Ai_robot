...
from app.utils.aimodels import get_embedding_model
...
from libs.data.vector import ORG_ID_FIELD, VIRTUAL_RECORD_ID_FIELD, IVectorDBService
...
class IndexingPipeline:
    ...
    async def get_embedding_model_instance(self) -> bool:
        try:
            ...
            if not dense_embeddings:
                raise IndexingError("No embedding model could be created from configuration")
