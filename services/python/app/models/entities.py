...
from libs.core.constants import Connectors, MimeTypes, OriginTypes
...
class RecordGroup(BaseModel):
    ...
    icon: Optional[str] = Field(default=None, description="Icon/emoji for the record group")
    ...
    def from_arango_base_record_group(arango_base_record_group: Dict) -> "RecordGroup":
        return RecordGroup(
            ...
            icon=arango_base_record_group.get("icon", None),
