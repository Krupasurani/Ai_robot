...
@ConnectorBuilder("Drive")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/google-workspace/drive/drive',
            'thero'
        ))
...
@ConnectorBuilder("Gmail")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/google-workspace/gmail/gmail',
            'thero'
        ))
    ...
    .configure(lambda builder: builder
        ...
        .add_auth_field(AuthField(
            ...
            description="The Bot User OAuth Access Token from Slack App settings. "
                        ...
                        "im:read, im:history, mpim:read, mpim:history, users:read, users:read.email, files:read",
            field_type="PASSWORD",
            max_length=8000,
            is_secret=True
        ))
        .add_auth_field(AuthField(
            name="requiredScopes",
            display_name="Required Bot Token Scopes",
            placeholder="Copy these scopes to your Slack App",
            description="Add these scopes to your Slack App under OAuth & Permissions → Scopes → Bot Token Scopes",
            field_type="TEXT",
            required=False,
            min_length=0,
            max_length=1000,
            default_value="channels:read, channels:history, groups:read, groups:history, im:read, im:history, mpim:read, mpim:history, users:read, users:read.email, files:read"
        ))
        .with_sync_strategies(["SCHEDULED", "MANUAL"])
        .with_scheduled_config(True, 60)
...
class SlackConnectorStub:
    """Slack connector stub - metadata only, implementation in sources/slack/connector.py"""
...
@ConnectorBuilder("Notion")\
    ...
    .build_decorator()
class NotionConnectorStub:
    """Notion connector stub - metadata only, implementation in sources/notion/connector.py"""
...
@ConnectorBuilder("Calendar")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/google-workspace/calendar/calendar',
            'thero'
        ))
...
@ConnectorBuilder("Meet")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/google-workspace/meet/meet',
            'thero'
        ))
...
@ConnectorBuilder("Docs")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/google-workspace/docs/docs',
            'thero'
        ))
...
@ConnectorBuilder("Sheets")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/google-workspace/sheets/sheets',
            'thero'
        ))
...
@ConnectorBuilder("Forms")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/google-workspace/forms/forms',
            'thero'
        ))
...
@ConnectorBuilder("Slides")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/google-workspace/slides/slides',
            'thero'
        ))
...
@ConnectorBuilder("Airtable")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/airtable/airtable',
            'thero'
        ))
        .with_redirect_uri("", False)
        .add_auth_field(AuthField(
...
@ConnectorBuilder("Azure Blob")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/azure/azureblob',
            'thero'
        ))
        .with_redirect_uri("", False)
        .add_auth_field(AuthField(
...
@ConnectorBuilder("BookStack")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/bookstack/bookstack',
            'thero'
        ))
        .with_redirect_uri("", False)
        .add_auth_field(AuthField(
...
@ConnectorBuilder("Linear")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/linear/linear',
            'thero'
        ))
        .with_redirect_uri("", False)
        .add_auth_field(AuthField(
...
@ConnectorBuilder("S3")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/s3/s3',
            'thero'
        ))
        .with_redirect_uri("", False)
        .add_auth_field(AuthField(
...
@ConnectorBuilder("ServiceNow")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/servicenow/servicenow',
            'thero'
        ))
        .with_redirect_uri("", False)
        .add_auth_field(AuthField(
...
@ConnectorBuilder("Zendesk")\
    ...
    .configure(lambda builder: builder
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/zendesk/zendesk',
            'thero'
        ))
        .with_redirect_uri("", False)
        .add_auth_field(AuthField(
