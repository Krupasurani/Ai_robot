...
class CreateKnowledgeBaseRequest(BaseModel):
    ...
    icon: Optional[str] = Field(None, description="Icon/emoji for the knowledge base", max_length=10)
    description: Optional[str] = Field(None, description="Description of the knowledge base", max_length=1000)
...
class KnowledgeBaseResponse(BaseModel):
    ...
    icon: Optional[str] = Field(None, description="Icon/emoji for the knowledge base")
    ...
    ownerName: Optional[str] = Field(None, description="Full name of the owner")
    ownerPhotoBase64: Optional[str] = Field(None, description="Owner's profile picture as Base64")
    ownerPhotoMimeType: Optional[str] = Field(None, description="MIME type of owner's profile picture")
