...
from app.sources.external.microsoft.users_groups.user_groups import (
...
@ConnectorBuilder("Outlook")\
    ...
    .configure(lambda builder: builder
        .with_icon("/assets/icons/platforms/ic-outlook.svg")
        ...
        .add_documentation_link(DocumentationLink(
            'Thero Documentation',
            'https://docs.thero.com/connectors/microsoft-365/outlook',
            'thero'
        ))
