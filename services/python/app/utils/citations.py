...
def normalize_citations_and_chunks_for_agent(answer_text: str, final_results: List[Dict[str, Any]]) -> tuple[str, List[Dict[str, Any]]]:
    ...
    and create corresponding citation chunks with correct mapping
    """
    # When no retrieval context is available, leave the text untouched and
    # skip creating structured citations. This is common in pure chat mode
    # where the model may still emit [1] style markers without real sources.
