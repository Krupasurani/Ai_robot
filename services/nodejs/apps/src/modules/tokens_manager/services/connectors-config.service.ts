...
import { HttpMethod as Method } from '../../../libs/enums/http-methods.enum';

export const fetchSambaConfig = async (
  ...
  const configurationManagerCommandOptions: ConfigurationManagerCommandOptions = {
    uri: `${url}/api/v1/configurationManager/connectors/sambaConfig`,
    method: Method.GET,
