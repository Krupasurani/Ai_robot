...
export const linkKnowledgeBaseSchema = z.object({
  params: z.object({ kbId: z.string().uuid() }),
  body: z.object({
    linkedKbId: z.string().uuid(),
  }),
});

export const unlinkKnowledgeBaseSchema = z.object({
  params: z.object({
    kbId: z.string().uuid(),
    linkedKbId: z.string().uuid(),
  }),
...
export const getLinkedKnowledgeBasesSchema = z.object({
  params: z.object({ kbId: z.string().uuid() }),
});
