...
import {
  ...
  unlinkKnowledgeBaseFromKnowledgeBase,
  getLinkedKnowledgeBases,
  updateKBPermission,
  removeKBPermission,
  createKBPermission,
  listKBPermissions,
...
import {
  ...
  unlinkKnowledgeBaseSchema,
  getLinkedKnowledgeBasesSchema,
...
export function createKnowledgeBaseRouter(container: Container): Router {
  ...
  router.post(
    ...
    authMiddleware.authenticate,
    metricsMiddleware(container),
    ValidationMiddleware.validate(linkKnowledgeBaseSchema),
    linkKnowledgeBaseToKnowledgeBase(appConfig),
  );
  ...
  router.get(
    ...
    authMiddleware.authenticate,
    metricsMiddleware(container),
    ValidationMiddleware.validate(getLinkedKnowledgeBasesSchema),
    getLinkedKnowledgeBases(appConfig),
  );

  router.delete(
    '/:kbId/links/:linkedKbId',
    authMiddleware.authenticate,
    metricsMiddleware(container),
    ValidationMiddleware.validate(unlinkKnowledgeBaseSchema),
    unlinkKnowledgeBaseFromKnowledgeBase(appConfig),
  );
