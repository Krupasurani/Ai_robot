...
export function createUserAccountRouter(container: Container) {
  ...
  // Multiple session management routes
  router.get(
    '/sessions',
    userValidator,
    async (req: AuthSessionRequest, res: Response, next: NextFunction) => {
      try {
        ...
        await userAccountController.getUserSessions(req, res, next);
      } catch (error) {
        next(error);
      }
    },
  ...
  router.delete(
    ...
    async (req: AuthSessionRequest, res: Response, next: NextFunction) => {
      try {
        ...
        await userAccountController.deleteSession(req, res, next);
      } catch (error) {
        next(error);
      }
    },
  ...
  router.delete(
    ...
    async (req: AuthSessionRequest, res: Response, next: NextFunction) => {
      try {
        ...
        await userAccountController.deleteAllOtherSessions(req, res, next);
      } catch (error) {
        next(error);
      }
    },
