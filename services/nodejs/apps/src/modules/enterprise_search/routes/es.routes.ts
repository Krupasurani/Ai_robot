...
export function createConversationalRouter(container: Container): Router {
  ...
  router.post(
    ...
    authMiddleware.authenticate,
    metricsMiddleware(container),
    ValidationMiddleware.validate(webSearchRequestSchema),
    performWebSearch(appConfig),
  );
...
export function createUnifiedChatRouter(container: Container): Router {
  const router = Router();
  const authMiddleware = container.get<AuthMiddleware>('AuthMiddleware');
  ...
  router.post(
    ...
    authMiddleware.authenticate,
    metricsMiddleware(container),
    ValidationMiddleware.validate(unifiedChatRequestSchema),
    unifiedChatStream(appConfig, 'chat'),
  );
  ...
  router.post(
    ...
    metricsMiddleware(container),
    ValidationMiddleware.validate(unifiedChatRequestSchema),
    unifiedChatStream(appConfig, 'knowledge'),
  );
  ...
  router.post(
    ...
    metricsMiddleware(container),
    ValidationMiddleware.validate(unifiedChatRequestSchema),
    unifiedChatStream(appConfig, 'deepResearch'),
  );
  ...
  router.post(
    ...
    metricsMiddleware(container),
    ValidationMiddleware.validate(unifiedChatRequestSchema),
    unifiedChatStream(appConfig, 'image'),
  );
  ...
  router.post(
    ...
    authMiddleware.authenticate,
    metricsMiddleware(container),
    ValidationMiddleware.validate(unifiedAgentChatRequestSchema),
    unifiedChatStream(appConfig, 'agent'),
  );
